#Question Link: https://leetcode.com/problems/container-with-most-water/?envType=daily-question&envId=2025-10-05
"""
...
class Solution:
    def maxArea(self, height: List[int]) -> int:
        ...
        max_area = 0  # To keep track of the largest area found
        
        # Loop until the two pointers meet
        while left < right:
            # Width of container is distance between pointers
            width = right - left
