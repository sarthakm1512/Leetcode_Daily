#Question Link: https://leetcode.com/problems/pacific-atlantic-water-flow/?envType=daily-question&envId=2025-10-06
"""
...
class Solution:
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        # DFS function: explore neighbors that are higher or equal in height
        def dfs(r, c, visited, prev_height):
            # Stop if out of bounds, already visited, or height is smaller than last cell
        ...
        # Sets to store cells that can reach Pacific and Atlantic
        ...
        # Cells that can reach both oceans = intersection
